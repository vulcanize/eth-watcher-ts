...
//616263313233000000000000000000000000000000000000000000000000000c
...
console.log('storageDataDecoded', storageDataDecoded, storageDataDecoded.toString('hex'), toUtf8(storageDataDecoded.toString('hex')));
